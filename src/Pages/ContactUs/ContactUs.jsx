    ...
    return (
        <div className="my-20 w-[70%] mx-auto">
            ...
            <div className="flex justify-center items-center my-10 font-bold">
                <h2 className="font-bold text-blue-700 text-4xl">Tech Trends</h2>

                
            </div>
            <div>
                    <h2 className="text-xl font-bold mb-4">Contact Us</h2>
                    <p>"Have questions or need assistance with your tech needs? We're here to help. Feel free to reach out."</p>
